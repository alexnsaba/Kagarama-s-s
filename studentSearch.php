 ...
 <div class="content-wrapper" style="margin-left: 0.5">
  ...
  <!--Put your page content here-->
   <center> <h2>Choose the search key and click the search button</h2> </center> 
        ...
        <form method="post" action="studentSearch.php" name="registration" class="form-horizontal">
...
<option selected="selected">admissionNumber</option>
</select>
</div>
</div>
...
<div><br><br><br>
  <?php  
    ...
    $d=mysqli_query($con,"select * from student  where $field='$key'");
