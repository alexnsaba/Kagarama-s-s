   ...
   echo' <div class="col-md-8" style="width: 900px">
          ...
          <div class="box box-success">
           <div class="box-header with-border">
              <h1 class="box-title">New Books</h1>
...
<div class="box-body no-padding">';
   ...
   date_default_timezone_set('Africa/Kampala');
     $date = date('Y/m/d');
      $sel = mysqli_query($con,"select * from book where dateOfReceipt='$date'");
  ...
  echo"</div>";
     ...
     echo"<center><h2>No new book records Found </h2></center>";
   }
...
//borrowed books report
  ...
  //Put your page content here-->
   echo' <div class="col-md-8" style="width: 900px">
          ...
          <div class="box box-success">
           <div class="box-header with-border">
              <h1 class="box-title">Books Borrowed Today</h1>
...
<div class="box-body no-padding">';
   ...
   $sel = mysqli_query($con,"select * from checkouts where  dateOfLend='$date' and status='UnReturned'");
   $num= mysqli_num_rows($sel);
   if($num >0){
  echo"<div class='box'>";
  echo"<div class='box-body'>";
 ...
 echo"<td><center>".$row['bookId']."</center></td>"; 
  ...
  echo"</div>";
     ...
     echo"<center><h2>No Book borrowed today</h2></center>";
   }
...
//Returned Books Report
  ...
  //Put your page content here-->
   echo' <div class="col-md-8" style="width: 900px">
          ...
          <div class="box box-success">
           <div class="box-header with-border">
              <h1 class="box-title">Today s Returned Books</h1>
...
<div class="box-body no-padding">';
   ...
   $sel = mysqli_query($con,"select * from checkIns where  returnDate = '$date'");
   $num= mysqli_num_rows($sel);
   if($num >0){
  echo"<div class='box'>";
  echo"<div class='box-body'>";
  ...
  echo"</div>";
     ...
     echo"<center><h2>No Book Returned to day</h2></center>";
   }
