...
<ul>
 ...
 <center> <h3>Enter the ISBN/ISSN and click the Delete button</h3> </center>
                <div class="panel-body">
      <form method="post" action="bookDel.php" class="form-horizontal">
...
<div class="col-sm-8">
<input type="text" name="bookId" id="bookId"  class="form-control"  required="required">
...
<div><br>
  <?php  
    ...
    $d=mysqli_query($con,"delete from book where isbn='$isbn'");    
    if($d){
          echo"<br/><p style='color:blue;font-size:20pt'> <i class='fa fa-check'></i> The Book ".$isbn." is deleted successfully</p>";
    }else{
   echo"<br/><p style='color:blue;font-size:20pt'><i class='fa fa-close'></i>Failed to delete the book. Try Again</p>";   
    }
   mysqli_close($con);  
  }
  ?>
