...
<ul>
 ...
 <ul>
  ...
  <div class="content-wrapper" style="margin-left: 0.5">
   ...
   <center> <h2>Enter The Student/Staff Number</h2> </center> 
                <div class="panel-body"> 

  <form method="post" action="verifyStudents.php" enctype="multipart/form-data" name="registration" class="form-horizontal">
...
<div class="col-sm-8">
<input type="text" name="studno" id="expType" class="form-control" placeholder="student Admission Number or staff Number" required="required" >
</div>
</div>
...
<div><br>
  <?php  
   ...
   if($cat=="staff"){
     $select= mysqli_query($con,"select * from staff where staffId ='$studno'");
     $number = mysqli_num_rows($select);
     $row= mysqli_fetch_array($select);
     if($number==1){
      echo "<h1><i class='fa fa-check'></i> ".$row['name']." is a Registered staff</h1>";
     }
     else{
          echo "<h1 style='color:red'><i class='fa fa-close'></i> The Staff is not registered.</h1>";

     }

   }else if($cat=="student"){
    $select= mysqli_query($con,"select * from student where admissionNumber ='$studno'");
     $number = mysqli_num_rows($select);
     $row= mysqli_fetch_array($select);
     if($number==1){
      echo "<h1><i class='fa fa-check'></i> ".$row['name']." is a Registered student</h1>";
     }
     else{
          echo "<h1 style='color:red'><i class='fa fa-close'></i> The Student is not registered.</h1>";
