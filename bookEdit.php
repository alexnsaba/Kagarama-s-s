...
<ul>
 ...
 <div class="content-wrapper" style="margin-left: 0.5">
  ...
  <!--Put your page content here-->
   <center> <h2>Choose a field to Edit and click the save button</h2> </center> 
                <div class="panel-body"> 

        <form method="post" action="bookEdit.php" name="registration" class="form-horizontal">
...
<div class="col-sm-8">
<input type="text" name="bId" id="bId"  class="form-control"  required="required">
...
<div><br>
  <?php  
   ...
   if($_POST['dep']=="title"){             
             ...
             else if($_POST['dep']=="author"){
                $field="author";
            }
             else if($_POST['dep']=="publisher"){
                $field="publisher";
            }
            else if($_POST['dep']=="edition"){
                $field="edition";
            }
             else if($_POST['dep']=="dateOfPublish"){
                $field="dateOfPublish";
                }
    ...
    $d=mysqli_query($con,"update book set $field='$value' where isbn ='$bId'");
    if($d){
