 ...
 <div class="content-wrapper" style="margin-left: 0.5">
  ...
  <!--Put your page content here-->
   <center> <h2>Choose the search key and click the search button</h2> </center> 
        ...
        <form method="post" action="staffSearch.php" name="registration" class="form-horizontal">
...
<div><br><br><br>
  <?php  
    ...
    $d=mysqli_query($con,"select * from staff  where $field='$key'");
  ...
  echo"</div>";
     ...
     echo"<center><h2>No Staff Records found.</h2></center>";
   }
   mysqli_close($con);  
  }
  ?>
