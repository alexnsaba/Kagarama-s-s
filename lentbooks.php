...
<ul>
 ...
 <center><h1> Borrowed Books</h1></center>
   <center>
   <?php
   require_once 'database.php';
   $sel = mysqli_query($con,"select * from checkouts where status ='UnReturned'");
  ...
  echo"<th><center>borrowerId</center>  </th>";
  ...
  echo"</div>";
     ...
     echo"<center><h2>No Borrowed Book is available .</h2></center>";
   }
  mysqli_close($con);
  ?>
  <center>
